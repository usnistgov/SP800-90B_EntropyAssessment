#ifndef CONDITIONINGTESTCASE_H
#define CONDITIONINGTESTCASE_H
...
class ConditioningTestCase : public TestCaseBase {
public:
    ...
    Json::Value GetAsJson() {
        ...
        //    json["h_in"] = h_in;
        if(h_out != -1)
            json["out_min_entropy"] = h_out;
        if(h_p != -1)
            json["evaluated_min_entropy"] = h_p;
        //if(vetted)
        //    json["vetted"] = vetted;
